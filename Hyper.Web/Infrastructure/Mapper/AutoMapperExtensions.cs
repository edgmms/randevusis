...
namespace Hyper.Web.Infrastructure.Mapper
{
    public static class AutoMapperExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity<int> entity) where TModel : BaseEntityModel<int>
        {
            if (entity == null)
        ...
        /// <param name="entity">Entity to map from</param>
        /// <returns>Mapped model</returns>
        public static TModel ToModel<TModel>(this Task<BaseEntity<int>> entity) where TModel : BaseEntityModel<int>
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity<int> where TModel : BaseEntityModel<int>
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseEntityModel<int> model) where TEntity : BaseEntity<int>
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
